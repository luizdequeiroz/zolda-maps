var subs = [
    { name: 'cinzenta', lat: 0.901, lng: -65.698, zoom: 6, descricao: '' },
    { name: 'saisepedras', lat: 13.923, lng: -69.368, zoom: 6, descricao: '' },
/*    */{ name: 'dosal', lat: 17.613, lng: -66.753, zoom: 7, descricao: '' },
/*    */{ name: 'dapedra', lat: 14.594, lng: -67.094, zoom: 7, descricao: '' },
/*    */{ name: 'detheus', lat: 9.990, lng: -66.302, zoom: 7, descricao: '' },
    { name: 'maraba', lat: 24.347, lng: -68.643, zoom: 6, descricao: '' },
...
/*    */{ name: 'ajaf', lat: 15.390, lng: -17.622, zoom: 7, descricao: '' },
    ...
    { name: 'mileni', lat: 3.974, lng: -0.198, zoom: 6, descricao: '' },
